...
namespace triangle {
   ...
   void Triangle::createSurface() {
    ...
    void Triangle::createGraphicsPipeline() {
		...
		bindingDescription.stride = sizeof(SimplePushConstantData);
		...
		attributeDescriptions[0].offset = offsetof(SimplePushConstantData, offset);

		attributeDescriptions[1].binding = 0;
		attributeDescriptions[1].location = 1;
		attributeDescriptions[1].format = VK_FORMAT_R32G32B32_SFLOAT;
		attributeDescriptions[1].offset = offsetof(SimplePushConstantData, color);
